...
var socialLinks = angular.module('socialLinks', []).factory('socialLinker', [
    ...
    'socialLinker', function(linker) {
      return {
        ...
        link: linker(function(scope, url) {
          return "https://facebook.com/sharer.php?u=" + (encodeURIComponent(scope.url));
        })
      };
    }
    ...
    'socialLinker', function(linker) {
      return {
        ...
        link: linker(function(scope, url) {
          scope.status || (scope.status = "Check this out! - " + scope.url);
...
//            alert("scope.media:"+ scope.media);
          return "http://pinterest.com/pin/create/button/?url=" + (encodeURIComponent(scope.url)) + "&amp;media=" + (encodeURIComponent(scope.media)) + "&amp;description=" + (encodeURIComponent(scope.description));
        })
      };
    }
  ])
