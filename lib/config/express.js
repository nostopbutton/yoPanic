...
//        app.use(express.favicon(path.join(config.root, 'public', 'favicon.ico')));
        app.use(favicon(path.join(config.root, 'app/public', 'favicon.ico')));
        app.use(express.static(path.join(config.root, 'app/public'))); // set the static files location /public/img will be /img for users
        app.use(errorHandler());
