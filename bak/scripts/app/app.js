...
//      Design Build routes
      ...
      .when('/item/:styleId/:itemId', {
        templateUrl: '/views/ng-partials/shopItem.html', controller: 'NewDesignBuildCtrl'//'ShopItemCtrl'
      })
    .when('/item/:styleId/:itemId/:tab', {
        templateUrl: '/views/ng-partials/shopItemBuy.html', controller: 'NewDesignBuildCtrl'//'ShopItemCtrl'
    })
